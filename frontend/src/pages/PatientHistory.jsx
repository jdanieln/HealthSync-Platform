    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-1">Consulta tus diagnósticos y prescripciones anteriores.</p>
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-xl shadow-sm p-12 text-center border">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">No se encontró historial médico</h3>
                    <p className="mt-1 text-gray-500">Cuando un médico registre un diagnóstico para ti, aparecerá aquí.</p>
                </div>
            ) : (
                            ...
                            <div key={diag.id} className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition">
                                <div className="bg-indigo-50 px-6 py-4 border-b border-indigo-100 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 font-medium">Médico Tratante</p>
                                ...
                                <div className="p-6 space-y-4">
                                    <div>
                                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Síntomas Reportados</h4>
                                        <p className="text-gray-800 bg-gray-50 p-3 rounded-md">{diag.symptoms}</p>
                                    </div>
                                    <div>
                                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Diagnóstico Médico</h4>
                                        <p className="text-gray-800 bg-gray-50 p-3 rounded-md">{diag.diagnosis}</p>
                                    </div>
                                    {diag.prescription && (
                                        <div>
                                            <h4 className="text-xs font-bold text-indigo-400 uppercase tracking-wider mb-1">Prescripción / Tratamiento</h4>
